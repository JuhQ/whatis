    ...
    const list = [
      {
        ...
        attometres: [
          ...
          { val: 1, to: 'zeptometre', result: 1e3 },
        ...
        femtometres: [
          ...
          { val: 1, to: 'zeptometre', result: 1e6 },
          { val: 1, to: 'attometres', result: 1e3 },
        ...
        picometres: [
          ...
          { val: 1, to: 'zeptometre', result: 1e9 },
          { val: 1, to: 'attometres', result: 1e6 },
          { val: 1, to: 'femtometres', result: 1e3 },
        ...
        nanometres: [
          ...
          { val: 1, to: 'zeptometre', result: 1e12 },
          { val: 1, to: 'attometres', result: 1e9 },
          { val: 1, to: 'femtometres', result: 1e6 },
          { val: 1, to: 'picometres', result: 1e3 },
        ...
        micrometres: [
          ...
          { val: 1, to: 'zeptometre', result: 1e15 },
          { val: 1, to: 'attometres', result: 1e12 },
          { val: 1, to: 'femtometres', result: 1e9 },
          { val: 1, to: 'picometres', result: 1e6 },
          { val: 1, to: 'nanometres', result: 1e3 },
        ...
        millimetre: [
          ...
          { val: 1, to: 'zeptometre', result: 1e18 },
          { val: 1, to: 'attometres', result: 1e15 },
          { val: 1, to: 'femtometres', result: 1e12 },
          { val: 1, to: 'picometres', result: 1e9 },
          { val: 1, to: 'nanometres', result: 1e6 },
          { val: 1, to: 'micrometres', result: 1e3 },
        ...
        centimetre: [
          ...
          { val: 1, to: 'zeptometre', result: 1e21 },
          { val: 1, to: 'attometres', result: 1e18 },
          { val: 1, to: 'femtometres', result: 1e15 },
          { val: 1, to: 'picometres', result: 1e12 },
          { val: 1, to: 'nanometres', result: 1e9 },
          { val: 1, to: 'micrometres', result: 1e6 },
          { val: 1, to: 'millimetres', result: 1e3 },
        ...
        decimetre: [
          ...
          { val: 1, to: 'zeptometre', result: 1e24 },
          { val: 1, to: 'attometres', result: 1e21 },
          { val: 1, to: 'femtometres', result: 1e18 },
          { val: 1, to: 'picometres', result: 1e15 },
          { val: 1, to: 'nanometres', result: 1e12 },
          { val: 1, to: 'micrometres', result: 1e9 },
          { val: 1, to: 'millimetres', result: 1e6 },
          { val: 1, to: 'centimetres', result: 1e3 },
        ...
        metre: [
          ...
          { val: 1, to: 'zeptometre', result: 1e27 },
          { val: 1, to: 'attometres', result: 1e24 },
          { val: 1, to: 'femtometres', result: 1e21 },
          { val: 1, to: 'picometres', result: 1e18 },
          { val: 1, to: 'nanometres', result: 1e15 },
          { val: 1, to: 'micrometres', result: 1e12 },
          { val: 1, to: 'millimetres', result: 1e9 },
          { val: 1, to: 'centimetres', result: 1e6 },
          { val: 1, to: 'decimetre', result: 1e3 },
        ...
        hectometre: [
          ...
          { val: 1, to: 'zeptometre', result: 1e33 },
          { val: 1, to: 'attometres', result: 1e30 },
          { val: 1, to: 'femtometres', result: 1e27 },
          { val: 1, to: 'picometres', result: 1e24 },
          { val: 1, to: 'nanometres', result: 1e21 },
          { val: 1, to: 'micrometres', result: 1e18 },
          { val: 1, to: 'millimetres', result: 1e15 },
          { val: 1, to: 'centimetres', result: 1e12 },
          { val: 1, to: 'decimetre', result: 1e9 },
          { val: 1, to: 'metre', result: 1e6 },
          { val: 1, to: 'decametre', result: 1e3 },
          { val: 1, to: 'hectometre', result: 1 },
          { val: 1, to: 'kilometre', result: 1e-3 },
        ],
        kilometre: [
          { val: 1, to: 'yoctometres', result: 1e39 },
          { val: 1, to: 'zeptometre', result: 1e36 },
          { val: 1, to: 'attometres', result: 1e33 },
          { val: 1, to: 'femtometres', result: 1e30 },
          { val: 1, to: 'picometres', result: 1e27 },
          { val: 1, to: 'nanometres', result: 1e24 },
          { val: 1, to: 'micrometres', result: 1e21 },
          { val: 1, to: 'millimetres', result: 1e18 },
          { val: 1, to: 'centimetres', result: 1e15 },
          { val: 1, to: 'decimetre', result: 1e12 },
          { val: 1, to: 'metre', result: 1e9 },
          { val: 1, to: 'decametre', result: 1e6 },
