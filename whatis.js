...
const inTime = val => {
  ...
  const planckTimeUnitMethod = createMethodPairs({
    ...
    fortnight: val * 2 * planckConstant * 60 * 60 * 24 * 7,
  ...
  const fortnightMethod = createMethodPairs({
    planck: val / planckConstant / 2 / 7 / 24 / 60 / 60,
    second: val / 2 / 7 / 24 / 60 / 60,
    minute: val / 2 / 7 / 24 / 60,
    hour: val / 2 / 7 / 24,
    day: val / 2 / 7,
    week: val / 2,
    fortnight: val,
    ...
    year: (val * 52) / 2,
    decade: (val * 52 * 10) / 2,
    century: (val * 52 * 100) / 2,
    millennium: (val * 52 * 1000) / 2,
  })
...
const inLength = val => {
  ...
  const gigametreMethod = createMethodPairs({
    yoctometre: val / 1e46,
    zeptometre: val / 1e42,
    attometre: val / 1e39,
    femtometre: val / 1e36,
